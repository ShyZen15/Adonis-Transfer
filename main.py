...
class functions():
    ...
    def Login(self, event=None):
        ...
        canv.tag_bind(loginBtn, "<Button-1>", obj.mainPage)
    ...
    def Register(self, event=None):
        ...
        canv.tag_bind(registerBtn, "<Button-1>", obj.mainPage)
    ...
    def mainPage(self, event=None):
        ...
        CANVAS.create_text(255, 185, text=f"Good {phase}, ShyZen!", fill="white", font=("Inter", 35, "bold"))
        CANVAS.create_text(255, 270, text="Don't be a Jeffery!", fill="white", font=("Inter", 35, "bold"))
        CANVAS.create_text(255, 350, text="Send a file or Receive one now!", fill="white", font=("Inter", 32, "bold"))
    ...
    def receivePage(self, event=None):
        obj = functions()
...
loginBtn = canvas.create_image(150, 400, image=loginImg, anchor=NW)
registerBtn = canvas.create_image(150, 600, image=RegisterImg, anchor=NW)
canvas.tag_bind(loginBtn, "<Button-1>", obj.mainPage)
canvas.tag_bind(registerBtn, "<Button-1>", obj.receivePage)
